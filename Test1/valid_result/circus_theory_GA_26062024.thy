...
definition "enteredSS_GasAnalysis_Chemical = \<lbrace> 
	  ...
	  entered_Reading_GasAnalysis_Chemical \<rbrace>"
...
locale state_proc_i1_GasAnalysis_Chemical
begin
...
locale state_proc_GasDetected_GasAnalysis_Chemical
begin
...
"Termination = (terminate \<rightarrow> Skip)" | 
"Active = ((SSTOP \<triangle> (get_gs_GasAnalysis_Chemical?(gs_GasAnalysis_Chemical) \<rightarrow> (SSTOP \<triangle> (set_ins_GasAnalysis_Chemical!intensity(gs_GasAnalysis_Chemical) \<rightarrow> Skip))));; (Behaviour;; Exiting))" | 
...
locale state_proc_j1_GasAnalysis_Chemical
begin
...
locale state_proc_Reading_GasAnalysis_Chemical
begin
...
locale state_proc_Analysis_GasAnalysis_Chemical
begin
...
"Termination = (terminate \<rightarrow> Skip)" | 
"Active = ((SSTOP \<triangle> (get_gs_GasAnalysis_Chemical?(gs_GasAnalysis_Chemical) \<rightarrow> (SSTOP \<triangle> (set_sts_GasAnalysis_Chemical!analysis(gs_GasAnalysis_Chemical) \<rightarrow> Skip))));; (Behaviour;; Exiting))" | 
...
locale state_proc_NoGas_GasAnalysis_Chemical
begin
...
\<comment> \<open>Main action of the process\<close>
definition "MainAction = cProcess prefixedTransAction_GasAnalysis_Chemical"
...
" ncBehaviourProc_GasAnalysis_Chemical = 
	(((((((((((state_proc_GasDetected_GasAnalysis_Chemical \<lbrakk> | \<lbrace> share,terminate \<rbrace> | \<rbrakk> state_proc_Reading_GasAnalysis_Chemical) \<lbrakk> | \<lbrace> share,terminate \<rbrace> | \<rbrakk> state_proc_Analysis_GasAnalysis_Chemical) \<lbrakk> | \<lbrace> share,terminate \<rbrace> | \<rbrakk> state_proc_i1_GasAnalysis_Chemical) \<lbrakk> | \<lbrace> share,terminate \<rbrace> | \<rbrakk> state_proc_j1_GasAnalysis_Chemical) \<lbrakk> | \<lbrace> share,terminate \<rbrace> | \<rbrakk> state_proc_NoGas_GasAnalysis_Chemical)
...
\<comment> \<open>Main action of the process\<close>
definition "MainAction = cProcess ncBehaviourProc_GasAnalysis_Chemical.MainAction"
