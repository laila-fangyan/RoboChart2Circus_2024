...
\<comment> \<open>undefined_op_move1_channel_stm0_C1_M_pkg0\<close>

move1Call :: "real\<times>int"
	
\<comment> \<open>undefined_op_move2_channel_stm0_C1_M_pkg0\<close>
...
"During = ((((SSTOP \<triangle> (get_l_stm0_C1_M_pkg0?(l_stm0_C1_M_pkg0) \<rightarrow> (SSTOP \<triangle> (get_a3_stm0_C1_M_pkg0?(a3_stm0_C1_M_pkg0) \<rightarrow> (SSTOP \<triangle> (set_a_stm0_C1_M_pkg0!((a3_stm0_C1_M_pkg0 + l_stm0_C1_M_pkg0) + 1) \<rightarrow> Skip))))));; move2(4,5));; SSTOP) \<triangle> (interrupt_s0_stm0_C1_M_pkg0 \<rightarrow> Skip))" | 
"Exiting = ((SSTOP \<triangle> (exit_stm0_C1_M_pkg0 \<rightarrow> Skip));; ((move(2,3);; move1(4,5));; (exited_stm0_C1_M_pkg0 \<rightarrow> Inactive)))"
