...
"Termination = (terminate \<rightarrow> Skip)" | 
"Active = ((SSTOP \<triangle> (event1_stm0_C1_pkg0_in?(a1_stm0_C1_pkg0_stm0_C1_pkg0) \<rightarrow> (SSTOP \<triangle> (set_a1_stm0_C1_pkg0_stm0_C1_pkg0!a1_stm0_C1_pkg0_stm0_C1_pkg0 \<rightarrow> Skip))));; (Behaviour;; Exiting))" | 
...
actions  is "(mychan, unit) action" where 
"SSTOP = share  \<rightarrow>  SSTOP" |
"prefixedTransAction_stm0 = (enter_i0_stm0_C1_pkg0 \<rightarrow> (((((((internal__stm0_C1_pkg0.(NID_i0_stm0_C1_pkg0) \<rightarrow> Skip);; (enter_s0_stm0_C1_pkg0 \<rightarrow> Skip))
  \<box>
  ((stop_stm0_C1_pkg0__in.(NID_s0_stm0_C1_pkg0) \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm0_C1_pkg0 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm0_C1_pkg0 \<rightarrow> Skip);; (enter_f0_stm0_C1_pkg0 \<rightarrow> Skip))))))
  \<box>
  ((event2_stm0_C1_pkg0__in.(NID_s0_stm0_C1_pkg0)?(a_stm0_C1_pkg0_stm0_C1_pkg0) \<rightarrow> (SSTOP \<triangle> (set_a_stm0_C1_pkg0_stm0_C1_pkg0!a_stm0_C1_pkg0_stm0_C1_pkg0 \<rightarrow> Skip)));; ((SSTOP \<triangle> (exit_stm0_C1_pkg0 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm0_C1_pkg0 \<rightarrow> (SSTOP \<triangle> (get_a1_stm0_C1_pkg0_stm0_C1_pkg0?(a1_stm0_C1_pkg0_stm0_C1_pkg0) \<rightarrow> (SSTOP \<triangle> (trigger1_stm0_C1_pkg0_out!a1_stm0_C1_pkg0_stm0_C1_pkg0 \<rightarrow> Skip)))));; (enter_s0_stm0_C1_pkg0 \<rightarrow> Skip))))))
  \<box>
