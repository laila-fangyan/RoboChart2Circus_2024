...
"crtlMemory_C1_M_pkg0(a3 :: int, a1 :: int\<times>int, m :: int, cv1 :: int, c3 :: int, c61 :: int, c2 :: int) = ((((set_cv1\<^bold>?x__ \<rightarrow> ctrlMemory_C1_M_pkg0(a3,a1,m,x__,c3,c61,c2))
  \<box>
  ((((set_Ext_a3\<^bold>?x__ \<rightarrow> (set_Ext_a3_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_a3_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(x__,a1,m,cv1,c3,c61,c2))
  \<box>
  ((set_Ext_a1\<^bold>?x__ \<rightarrow> (set_Ext_a1_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_a1_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(a3,x__,m,cv1,c3,c61,c2)))
  \<box>
  ((set_Ext_m\<^bold>?x__ \<rightarrow> (set_Ext_m_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_m_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(a3,a1,x__,cv1,c3,c61,c2))))
  \<box>
  (terminate \<rightarrow> Skip)))" | 
...
"modMemory_action_M_pkg0(a3 :: int, a1 :: int\<times>int, m :: int, pv1 :: int, c3 :: int, c2 :: int) = (((((((set_a3\<^bold>?x__ \<rightarrow> (set_Ext_a3_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(x__,a1,m,pv1,c3,c2))
  \<box>
  ((set_a1\<^bold>?x__ \<rightarrow> (set_Ext_a1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(a3,x__,m,pv1,c3,c2)))
  \<box>
  ((set_m\<^bold>?x__ \<rightarrow> (set_Ext_m_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(a3,a1,x__,pv1,c3,c2)))
  \<box>
  (set_pv1\<^bold>?x__ \<rightarrow> modMemory_M_pkg0(a3,a1,m,x__,c3,c2)))
  \<box>
  (terminate \<rightarrow> Skip)))"
