...
definition "enteredSS_stm0_C1_pkg1 = \<lbrace> 
	  ...
	  entered_f0_stm0_C1_pkg1 \<rbrace>"
...
definition "parallel_chanset_ncCoreBeh_stm0_C1_pkg1 = \<lbrace> 
	  ...
	  exited_stm0_C1_pkg1, 
	  stop_stm0_C1_pkg1__in.NID_s0_stm0_C1_pkg1, 
	  enter_i0_stm0_C1_pkg1, 
	  enter_f0_stm0_C1_pkg1, 
	  share, 
	  terminate, 
...
"Termination = (terminate \<rightarrow> Skip)" | 
"Active = ((SSTOP \<triangle> (event1_stm0_C1_pkg1_in?(a1_stm0_C1_pkg1) \<rightarrow> (SSTOP \<triangle> (set_a1_stm0_C1_pkg1!a1_stm0_C1_pkg1 \<rightarrow> Skip))));; (Behaviour;; Exiting))" | 
"Behaviour = (entered_s0_stm0_C1_pkg1 \<rightarrow> During)" | 
"During = (((SSTOP \<triangle> (get_a1_stm0_C1_pkg1?(a1_stm0_C1_pkg1) \<rightarrow> (SSTOP \<triangle> (get_l_stm0_C1_pkg1?(l_stm0_C1_pkg1) \<rightarrow> (SSTOP \<triangle> (set_a_stm0_C1_pkg1!((a1_stm0_C1_pkg1 + l_stm0_C1_pkg1) + 1) \<rightarrow> Skip))))));; SSTOP) \<triangle> (interrupt_s0_stm0_C1_pkg1 \<rightarrow> Skip))" | 
...
actions  is "(mychan, unit) action" where 
"SSTOP = share  \<rightarrow>  SSTOP" |
"prefixedTransAction_stm0 = (enter_i0_stm0_C1_pkg1 \<rightarrow> (((((((internal__stm0_C1_pkg1.(NID_i0_stm0_C1_pkg1) \<rightarrow> Skip);; (enter_s0_stm0_C1_pkg1 \<rightarrow> Skip))
  \<box>
  ((stop_stm0_C1_pkg1__in.(NID_s0_stm0_C1_pkg1) \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm0_C1_pkg1 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm0_C1_pkg1 \<rightarrow> Skip);; (enter_f0_stm0_C1_pkg1 \<rightarrow> Skip))))))
  \<box>
  ((event2_stm0_C1_pkg1__in.(NID_s0_stm0_C1_pkg1)?(a_stm0_C1_pkg1) \<rightarrow> (SSTOP \<triangle> (set_a_stm0_C1_pkg1!a_stm0_C1_pkg1 \<rightarrow> Skip)));; ((SSTOP \<triangle> (exit_stm0_C1_pkg1 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm0_C1_pkg1 \<rightarrow> (SSTOP \<triangle> (get_a1_stm0_C1_pkg1?(a1_stm0_C1_pkg1) \<rightarrow> (SSTOP \<triangle> (trigger1_stm0_C1_pkg1_out!a1_stm0_C1_pkg1 \<rightarrow> Skip)))));; (enter_s0_stm0_C1_pkg1 \<rightarrow> Skip))))))
  \<box>
...
" ncBehaviourProc_stm0_C1_pkg1 = 
	((((((((state_proc_s0_stm0_C1_pkg1 \<lbrakk> | \<lbrace> share,terminate \<rbrace> | \<rbrakk> state_proc_f0_stm0_C1_pkg1) \<lbrakk> | \<lbrace> share,terminate \<rbrace> | \<rbrakk> state_proc_i0_stm0_C1_pkg1)
	 ...
	 interrupt_s0_stm0_C1_pkg1 \<mapsto> stop_stm0_C1_pkg1__in.NID_s0_stm0_C1_pkg1,  
	 ...
	 interrupt_f0_stm0_C1_pkg1 \<mapsto> interrupt_stm0_C1_pkg1 ])
	  [ share \<mapsto> share ]) \<lbrakk> | parallel_chanset_ncCoreBeh_stm0_C1_pkg1 | \<rbrakk> (trans_proc_stm0_C1_pkg1
	  [ share \<mapsto> share ]))
	  [  ]) \<Zhide> ncCoreBeh_hideset_stm0_C1_pkg1)
	  [ event2_stm0_C1_pkg1__in\<cdot>x \<mapsto> event2_stm0_C1_pkg1_in,  
	 stop_stm0_C1_pkg1__in\<cdot>x \<mapsto> stop_stm0_C1_pkg1_in ]) "

\<comment> \<open>Main action of the process\<close>
definition "MainAction = cProcess ncBehaviourProc_stm0_C1_pkg1.MainAction"
end
