...
\<comment> \<open>constant and function definition\<close>
consts angle :: "nat \<Rightarrow> nat"
definition c61 :: "int"
where c61 = 8
consts c1 :: "int"
...
"varMemory_move_C1_M_pkg0 = (Memory_mv_var2_move_C1_M_pkg0(0)
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  Memory_mv_var1_move_C1_M_pkg0(0))" | 
...
"crtlMemory_C1_M_pkg0(a3 :: int, a1 :: int\<times>int, m :: int, cv1 :: int, c61 :: int, c3 :: int, c2 :: int) = ((((set_cv1\<^bold>?x__ \<rightarrow> ctrlMemory_C1_M_pkg0(a3,a1,m,x__,c61,c3,c2))
  \<box>
  ((((set_Ext_a3\<^bold>?x__ \<rightarrow> (set_Ext_a3_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_a3_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(x__,a1,m,cv1,c61,c3,c2))
  \<box>
  ((set_Ext_a1\<^bold>?x__ \<rightarrow> (set_Ext_a1_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_a1_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(a3,x__,m,cv1,c61,c3,c2)))
  \<box>
  ((set_Ext_m\<^bold>?x__ \<rightarrow> (set_Ext_m_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_m_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(a3,a1,x__,cv1,c61,c3,c2))))
  \<box>
  (terminate \<rightarrow> Skip)))" | 
...
"controller_action_C1_M_pkg0 = ((composeMachines_C1_M_pkg0
  ...
  crtlMemory_C1_M_pkg0(0,0,0,0,0,8,c3,c2)) \<Zhide> \<lbrace> set_cv1,set_EXT_a3,set_EXT_m,set_EXT_a1,set_c61 \<rbrace>)"
...
"modMemory_action_M_pkg0(pv1 :: int, a3 :: int, a1 :: int\<times>int, m :: int, c3 :: int, c2 :: int) = ((((((set_pv1\<^bold>?x__ \<rightarrow> modMemory_M_pkg0(x__,a3,a1,m,c3,c2))
  \<box>
  ((set_a3\<^bold>?x__ \<rightarrow> (set_Ext_a3_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(pv1,x__,a1,m,c3,c2)))
  \<box>
  ((set_a1\<^bold>?x__ \<rightarrow> (set_Ext_a1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(pv1,a3,x__,m,c3,c2)))
  \<box>
  ((set_m\<^bold>?x__ \<rightarrow> (set_Ext_m_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(pv1,a3,a1,x__,c3,c2)))
  \<box>
  (terminate \<rightarrow> Skip)))"
