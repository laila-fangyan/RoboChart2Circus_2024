...
"sharedVarMemory_stm0_C1_M_pkg0 = ((sharedMemory_a1((0,0))
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  sharedMemory_m(0))
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  sharedMemory_a3(0))" | 

"stm_stm0_C1_M_pkg0 = ((((((stateful_stm0_C1_M_pkg0 \<Zhide> \<lbrace> terminate \<rbrace>);; (SSTOP \<triangle> (terminate \<rightarrow> Skip))) [ share \<mapsto> set_EXT_a1,  
...
"varMemory_stm1_C1_M_pkg0 = (Memory_a_stm1_C1_M_pkg0(0)
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  Memory_l_stm1_C1_M_pkg0(c6))" | 
...
"sharedVarMemory_stm1_C1_M_pkg0 = ((sharedMemory_a1((0,0))
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  sharedMemory_m(0))
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  sharedMemory_a3(0))" | 

"stm_stm1_C1_M_pkg0 = ((((((stateful_stm1_C1_M_pkg0 \<Zhide> \<lbrace> terminate \<rbrace>);; (SSTOP \<triangle> (terminate \<rightarrow> Skip))) [ share \<mapsto> set_EXT_a1,  
 share \<mapsto> set_EXT_m,  
 share \<mapsto> set_EXT_a3 ])
  \<lbrakk> | \<lbrace> shared \<rbrace> | \<rbrakk> 
  Skip)
...
"crtlMemory_C1_M_pkg0(a1 :: int\<times>int, m :: int, a3 :: int, cv1 :: int, c3 :: int, c2 :: int, c61 :: int) = ((((set_cv1\<^bold>?x__ \<rightarrow> ctrlMemory_C1_M_pkg0(a1,m,a3,x__,c3,c2,c61))
  \<box>
  ((((set_Ext_a1\<^bold>?x__ \<rightarrow> (set_Ext_a1_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_a1_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(x__,m,a3,cv1,c3,c2,c61))
  \<box>
  ((set_Ext_m\<^bold>?x__ \<rightarrow> (set_Ext_m_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_m_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(a1,x__,a3,cv1,c3,c2,c61)))
  \<box>
  ((set_Ext_a3\<^bold>?x__ \<rightarrow> (set_Ext_a3_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_a3_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(a1,m,x__,cv1,c3,c2,c61))))
  \<box>
  (terminate \<rightarrow> Skip)))" | 
...
"controller_action_C1_M_pkg0 = ((composeMachines_C1_M_pkg0
  ...
  crtlMemory_C1_M_pkg0((0,0),0,0,0,c3,c2,8)) \<Zhide> \<lbrace> set_cv1,set_EXT_a3,set_EXT_m,set_EXT_a1,set_c61 \<rbrace>)"
...
"modMemory_action_M_pkg0(a1 :: int\<times>int, m :: int, pv1 :: int, a3 :: int, c3 :: int, c2 :: int) = (((((((set_a1\<^bold>?x__ \<rightarrow> (set_Ext_a1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(x__,m,pv1,a3,c3,c2))
  \<box>
  ((set_m\<^bold>?x__ \<rightarrow> (set_Ext_m_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(a1,x__,pv1,a3,c3,c2)))
  \<box>
  (set_pv1\<^bold>?x__ \<rightarrow> modMemory_M_pkg0(a1,m,x__,a3,c3,c2)))
  \<box>
  ((set_a3\<^bold>?x__ \<rightarrow> (set_Ext_a3_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(a1,m,pv1,x__,c3,c2)))
  \<box>
  (terminate \<rightarrow> Skip)))"
