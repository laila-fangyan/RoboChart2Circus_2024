...
definition "enteredSS_in_stmbd_stm1_C1_M_pkg0 = \<lbrace> 
	  ...
	  entered_f0_stm1_C1_M_pkg0 \<rbrace>"
...
"ncCoreBehaviour_stm1_C1_M_pkg0 = ((((composeNodes_stm1_C1_M_pkg0 [ interrupt_i0_stm1_C1_M_pkg0 \<mapsto> internal__stm1_C1_M_pkg0\<cdot>NID_i0_stm1_C1_M_pkg0,  
 ...
 interrupt_s0_stm1_C1_M_pkg0 \<mapsto> interrupt_stm1_C1_M_pkg0,  
 interrupt_f0_stm1_C1_M_pkg0 \<mapsto> interrupt_stm1_C1_M_pkg0 ]) [ share \<mapsto> share,  
...
"ncBehaviour_stm1_C1_M_pkg0 = ((ncCoreBehaviour_stm1_C1_M_pkg0 \<Zhide> \<lbrace> enter_i0_stm1_C1_M_pkg0,enter_s0_stm1_C1_M_pkg0,enter_f0_stm1_C1_M_pkg0,exit_stm1_C1_M_pkg0,exited_stm1_C1_M_pkg0,internal__stm1_C1_M_pkg0 \<rbrace>) [ stop__in\<cdot>x \<mapsto> stop_in,  
...
"sharedVarMemory_stm1_C1_M_pkg0 = ((sharedMemory_a3(0)
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  sharedMemory_a1(0,0))
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  sharedMemory_m(0))" | 

"stm_stm1_C1_M_pkg0 = ((((((stateful_stm1_C1_M_pkg0 \<Zhide> \<lbrace> terminate \<rbrace>);; (SSTOP \<triangle> (terminate \<rightarrow> Skip))) [ share \<mapsto> set_EXT_a3,  
 share \<mapsto> set_EXT_a1,  
 share \<mapsto> set_EXT_m ])
  \<lbrakk> | \<lbrace> shared \<rbrace> | \<rbrakk> 
  Skip)
  \<lbrakk> | \<lbrace> get_a1,get_a3,set_m,set_EXT_a3,set_EXT_m,terminate,set_a3,set_a1,set_EXT_a1,get_m \<rbrace> | \<rbrakk> 
...
"ncCoreBehaviour_stm0_C1_M_pkg0 = ((((composeNodes_stm0_C1_M_pkg0 [ interrupt_i0_stm0_C1_M_pkg0 \<mapsto> internal__stm0_C1_M_pkg0\<cdot>NID_i0_stm0_C1_M_pkg0,  
 ...
 interrupt_f0_stm0_C1_M_pkg0 \<mapsto> interrupt_stm0_C1_M_pkg0 ]) [ share \<mapsto> share,  
 set_a3 \<mapsto> setL_a3 ])
...
"ncBehaviour_stm0_C1_M_pkg0 = ((ncCoreBehaviour_stm0_C1_M_pkg0 \<Zhide> \<lbrace> enter_i0_stm0_C1_M_pkg0,enter_s0_stm0_C1_M_pkg0,enter_f0_stm0_C1_M_pkg0,exit_stm0_C1_M_pkg0,exited_stm0_C1_M_pkg0,internal__stm0_C1_M_pkg0 \<rbrace>) [ event2__in\<cdot>x \<mapsto> event2_in,  
...
"varMemory_stm0_C1_M_pkg0 = (Memory_a_stm0_C1_M_pkg0(0)
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  Memory_l_stm0_C1_M_pkg0(c6))" | 
...
"sharedVarMemory_stm0_C1_M_pkg0 = ((sharedMemory_a3(0)
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  sharedMemory_a1(0,0))
  \<lbrakk> | \<lbrace> terminate \<rbrace> | \<rbrakk> 
  sharedMemory_m(0))" | 

"stm_stm0_C1_M_pkg0 = ((((((stateful_stm0_C1_M_pkg0 \<Zhide> \<lbrace> terminate \<rbrace>);; (SSTOP \<triangle> (terminate \<rightarrow> Skip))) [ share \<mapsto> set_EXT_a3,  
 share \<mapsto> set_EXT_a1,  
 share \<mapsto> set_EXT_m ])
  \<lbrakk> | \<lbrace> shared \<rbrace> | \<rbrakk> 
  Skip)
...
"composeMachines_C1_M_pkg0 = ((stm_stm1_C1_M_pkg0 [ set_c3 \<mapsto> set_c3,  
 set_c2 \<mapsto> set_c2 ])
  \<lbrakk> | \<lbrace> terminate,set_c2,set_c3 \<rbrace> | \<rbrakk> 
  (stm_stm0_C1_M_pkg0 [ set_c3 \<mapsto> set_c3,  
 set_c2 \<mapsto> set_c2 ]))" | 

"crtlMemory_C1_M_pkg0(a3 :: int, a1 :: int\<times>int, m :: int, cv1 :: int, c3 :: int, c2 :: int) = ((((set_cv1\<^bold>?x__ \<rightarrow> ctrlMemory_C1_M_pkg0(a3,a1,m,x__,c3,c2))
  \<box>
  ((((set_Ext_a3\<^bold>?x__ \<rightarrow> (set_Ext_a3_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_a3_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(x__,a1,m,cv1,c3,c2))
  \<box>
  ((set_Ext_a1\<^bold>?x__ \<rightarrow> (set_Ext_a1_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_a1_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(a3,x__,m,cv1,c3,c2)))
  \<box>
  ((set_Ext_m\<^bold>?x__ \<rightarrow> (set_Ext_m_stm0_C1_M_pkg0\<^bold>!x__ \<rightarrow> (set_Ext_m_stm1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip)));; ctrlMemory_C1_M_pkg0(a3,a1,x__,cv1,c3,c2))))
  \<box>
  (terminate \<rightarrow> Skip)))" | 
...
"controller_action_C1_M_pkg0 = ((composeMachines_C1_M_pkg0
  ...
  crtlMemory_C1_M_pkg0(0,0,0,0,0,c3,c2)) \<Zhide> \<lbrace> set_cv1,set_EXT_a3,set_EXT_m,set_EXT_a1 \<rbrace>)"
...
"modMemory_action_M_pkg0(a3 :: int, pv1 :: int, a1 :: int\<times>int, m :: int, c3 :: int, c2 :: int) = (((((((set_a3\<^bold>?x__ \<rightarrow> (set_Ext_a3_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(x__,pv1,a1,m,c3,c2))
  \<box>
  (set_pv1\<^bold>?x__ \<rightarrow> modMemory_M_pkg0(a3,x__,a1,m,c3,c2)))
  \<box>
  ((set_a1\<^bold>?x__ \<rightarrow> (set_Ext_a1_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(a3,pv1,x__,m,c3,c2)))
  \<box>
  ((set_m\<^bold>?x__ \<rightarrow> (set_Ext_m_C1_M_pkg0\<^bold>!x__ \<rightarrow> Skip));; modMemory_M_pkg0(a3,pv1,a1,x__,c3,c2)))
  \<box>
  (terminate \<rightarrow> Skip)))"
