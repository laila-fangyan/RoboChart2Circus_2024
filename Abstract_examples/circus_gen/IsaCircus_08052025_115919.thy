...
" Trans_stm4 = 
	((SSTOP \<triangle> (get_v1\<^bold>?v1 \<rightarrow> (((((((n = i0) \<^bold>& (((internal__stm4\<^bold>.NID_i0_stm4 \<rightarrow> (SSTOP \<triangle> (set_v1\<^bold>!1 \<rightarrow> Skip)));; (enter_s0_stm4 \<rightarrow> Trans_stm4(s0_stm4)))))
	  \<box>
	  ((n = s0) \<^bold>& ((((v1 \<ge> 1)) \<^bold>& (((internal__stm4\<^bold>.NID_s0_stm4 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm4 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm4 \<rightarrow> Skip);; (enter_s1_stm4 \<rightarrow> Trans_stm4(s1_stm4)))))))))))
	  \<box>
	  ((n = s1) \<^bold>& ((((v1 < 1)) \<^bold>& (((internal__stm4\<^bold>.NID_s1_stm4 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm4 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm4 \<rightarrow> Skip);; (enter_s0_stm4 \<rightarrow> Trans_stm4(s0_stm4)))))))))))
	  \<box>
	  ((n = s1) \<^bold>& (((a__in\<^bold>.NID_s1_stm4 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm4 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm4 \<rightarrow> Skip);; (enter_s0_stm4 \<rightarrow> Trans_stm4(s0_stm4)))))))))
	  \<box>
