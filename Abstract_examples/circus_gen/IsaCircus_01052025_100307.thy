...
" Trans_stm4 = 
	(SSTOP \<triangle> (get_v1\<^bold>?v1 \<rightarrow> ((((((((internal__stm4\<^bold>.NID_i0_stm4 \<rightarrow> (SSTOP \<triangle> (set_v1\<^bold>!1 \<rightarrow> Skip)));; (enter_s0_stm4 \<rightarrow> Skip))
	  \<box>
	  ((v1 \<ge> 1) \<^bold>& (((internal__stm4\<^bold>.NID_s0_stm4 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm4 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm4 \<rightarrow> Skip);; (enter_s1_stm4 \<rightarrow> Skip))))))))
	  \<box>
	  ((v1 < 1) \<^bold>& (((internal__stm4\<^bold>.NID_s1_stm4 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm4 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm4 \<rightarrow> Skip);; (enter_s0_stm4 \<rightarrow> Skip))))))))
	  \<box>
	  ((a__in\<^bold>.NID_s1_stm4 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm4 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm4 \<rightarrow> Skip);; (enter_s0_stm4 \<rightarrow> Skip))))))
	  \<box>
	  (share \<rightarrow> Skip));; Trans_stm4)
	  \<box>
