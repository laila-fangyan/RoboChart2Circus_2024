...
" ncCoreBehaviour_stm0 = 
	(((composeNodes_stm0 [ interrupt_i0_stm0 \<mapsto> internal__stm0\<cdot>NID_i0_stm0,  
	 interrupt_s0_stm0 \<mapsto> a__in\<cdot>NID_s0_stm0,  
	 interrupt_s1_stm0 \<mapsto> b__in\<cdot>NID_s1_stm0,  
	 interrupt_s1_stm0 \<mapsto> interrupt_stm0,  
	 interrupt_s0_stm0 \<mapsto> interrupt_stm0 ]) [ share \<mapsto> share ])
	  \<lbrakk> | \<lbrace> internal__stm0\<cdot>NID_i0_stm0,interrupt_stm0,enter_i0_stm0,b__in\<cdot>NID_s1_stm0,exited_stm0,share,enter_s1_stm0,exit_stm0,terminate,a__in\<cdot>NID_s0_stm0,enter_s0_stm0 \<rbrace> | \<rbrakk> 
	  ((enter_i0_stm0 \<rightarrow> Trans_stm0) [ share \<mapsto> share ])) "

" ncBehaviour_stm0 = 
	((ncCoreBehaviour_stm0 \<Zhide> \<lbrace> enter_i0_stm0,enter_s0_stm0,enter_s1_stm0,exit_stm0,exited_stm0,internal__stm0 \<rbrace>) [ b__in\<cdot>x \<mapsto> b_in,  
...
" stateful_stm0 = 
	((machineBody_stm0
	  ...
	  varMemory_stm0) \<Zhide> \<lbrace> terminate \<rbrace>) "
