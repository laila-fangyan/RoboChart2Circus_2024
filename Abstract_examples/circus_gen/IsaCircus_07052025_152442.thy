...
" Trans_stm1 = 
	((((((((n_ = i0) \<^bold>& (((internal__stm1\<^bold>.NID_i0_stm1 \<rightarrow> Skip);; (enter_s0_stm1 \<rightarrow> Trans_stm1(s0_stm1)))))
	  \<box>
	  ((n_ = s0) \<^bold>& (((a__in\<^bold>.NID_s0_stm1 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm1 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm1 \<rightarrow> Skip);; (enter_s1_stm1 \<rightarrow> Trans_stm1(s1_stm1)))))))))
	  \<box>
	  ((n_ = s1) \<^bold>& (((b__in\<^bold>.NID_s1_stm1 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm1 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm1 \<rightarrow> Skip);; (enter_s0_stm1 \<rightarrow> Trans_stm1(s0_stm1)))))))))
	  \<box>
	  ((n_ = s1) \<^bold>& (((internal__stm1\<^bold>.NID_s1_stm1 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm1 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm1 \<rightarrow> Skip);; (enter_f0_stm1 \<rightarrow> Trans_stm1(f0_stm1)))))))))
	  \<box>
