...
" Trans_stm1 = 
	((((((((internal__stm1\<^bold>.NID_i0_stm1 \<rightarrow> Skip);; (enter_s0_stm1 \<rightarrow> Skip))
	  \<box>
	  ((a__in\<^bold>.NID_s0_stm1 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm1 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm1 \<rightarrow> Skip);; (enter_s1_stm1 \<rightarrow> Skip))))))
	  \<box>
	  ((b__in\<^bold>.NID_s1_stm1 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm1 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm1 \<rightarrow> Skip);; (enter_s0_stm1 \<rightarrow> Skip))))))
	  \<box>
	  ((internal__stm1\<^bold>.NID_s1_stm1 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm1 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm1 \<rightarrow> Skip);; (enter_f0_stm1 \<rightarrow> Skip))))))
	  \<box>
	  (share \<rightarrow> Skip));; Trans_stm1)
	  \<box>
...
" ncCoreBehaviour_stm1 = 
	(((composeNodes_stm1 [ interrupt_i0_stm1 \<mapsto> internal__stm1\<cdot>NID_i0_stm1,  
	 ...
	 interrupt_s0_stm1 \<mapsto> interrupt_stm1,  
	 interrupt_s1_stm1 \<mapsto> interrupt_stm1,  
	 interrupt_f0_stm1 \<mapsto> interrupt_stm1 ]) [ share \<mapsto> share ])
...
" ncBehaviour_stm1 = 
	((ncCoreBehaviour_stm1 \<Zhide> \<lbrace> enter_i0_stm1,enter_s0_stm1,enter_s1_stm1,enter_f0_stm1,exit_stm1,exited_stm1,internal__stm1 \<rbrace>) [ b__in\<cdot>x \<mapsto> b_in,  
