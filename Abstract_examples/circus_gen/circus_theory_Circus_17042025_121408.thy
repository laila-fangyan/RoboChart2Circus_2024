...
" Inactive_i0_stm3_ex2 = 
	(SSTOP \<triangle> (Activation_i0_stm3_ex2
	  \<box>
	  Termination_i0_stm3_ex2)) "

" Activation_i0_stm3_ex2 = 
	(enter_i0_stm3_ex2 \<rightarrow> Active_i0_stm3_ex2) "

" Termination_i0_stm3_ex2 = 
	(terminate \<rightarrow> Skip) "

" Active_i0_stm3_ex2 = 
	((SSTOP \<triangle> (interrupt_i0_stm3_ex2 \<rightarrow> Skip));; Inactive_i0_stm3_ex2) "
...
" Activation_s0_stm3_ex2 = 
	(enter_s0_stm3_ex2 \<rightarrow> Active_s0_stm3_ex2) "

" Termination_s0_stm3_ex2 = 
	(terminate \<rightarrow> Skip) "

" Active_s0_stm3_ex2 = 
	(Skip;; (Behaviour_s0_stm3_ex2;; Exiting_s0_stm3_ex2)) "

" Behaviour_s0_stm3_ex2 = 
	(entered_s0_stm3_ex2 \<rightarrow> During_s0_stm3_ex2) "

" During_s0_stm3_ex2 = 
	((Skip;; SSTOP) \<triangle> (interrupt_s0_stm3_ex2 \<rightarrow> Skip)) "

" Exiting_s0_stm3_ex2 = 
	((SSTOP \<triangle> (exit_stm3_ex2 \<rightarrow> Skip));; (Skip;; (exited_stm3_ex2 \<rightarrow> Inactive_s0_stm3_ex2))) "
...
" Activation_s1_stm3_ex2 = 
	(enter_s1_stm3_ex2 \<rightarrow> Active_s1_stm3_ex2) "

" Termination_s1_stm3_ex2 = 
	(terminate \<rightarrow> Skip) "

" Active_s1_stm3_ex2 = 
	(Skip;; (Behaviour_s1_stm3_ex2;; Exiting_s1_stm3_ex2)) "

" Behaviour_s1_stm3_ex2 = 
	(entered_s1_stm3_ex2 \<rightarrow> During_s1_stm3_ex2) "

" During_s1_stm3_ex2 = 
	((Skip;; SSTOP) \<triangle> (interrupt_s1_stm3_ex2 \<rightarrow> Skip)) "

" Exiting_s1_stm3_ex2 = 
	((SSTOP \<triangle> (exit_stm3_ex2 \<rightarrow> Skip));; (Skip;; (exited_stm3_ex2 \<rightarrow> Inactive_s1_stm3_ex2))) "

" composeNodes_stm3_ex2 = 
	((Inactive_i0_stm3_ex2
...
" Trans_stm3_ex2 = 
	(SSTOP \<triangle> (get_v1\<^bold>?v1 \<rightarrow> ((((((((internal__stm3_ex2\<^bold>.NID_i0_stm3_ex2 \<rightarrow> Skip);; (enter_s0_stm3_ex2 \<rightarrow> Skip))
	  \<box>
	  ((v1 \<ge> 1) \<^bold>& (((internal__stm3_ex2\<^bold>.NID_s0_stm3_ex2 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm3_ex2 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm3_ex2 \<rightarrow> Skip);; (enter_s1_stm3_ex2 \<rightarrow> Skip))))))))
	  \<box>
	  ((v1 < 1) \<^bold>& (((internal__stm3_ex2\<^bold>.NID_s1_stm3_ex2 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm3_ex2 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm3_ex2 \<rightarrow> Skip);; (enter_s0_stm3_ex2 \<rightarrow> Skip))))))))
	  \<box>
	  ((a__in\<^bold>.NID_s1_stm3_ex2 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm3_ex2 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm3_ex2 \<rightarrow> Skip);; (enter_s0_stm3_ex2 \<rightarrow> Skip))))))
	  \<box>
	  (share \<rightarrow> Skip));; Trans_stm3_ex2)
	  \<box>
...
" ncCoreBehaviour_stm3_ex2 = 
	(((composeNodes_stm3_ex2 [ interrupt_i0_stm3_ex2 \<mapsto> internal__stm3_ex2\<cdot>NID_i0_stm3_ex2,  
	 ...
	 interrupt_s0_stm3_ex2 \<mapsto> interrupt_stm3_ex2 ]) [ share \<mapsto> share ])
	  \<lbrakk> | \<lbrace> exited_stm3_ex2,a__in\<cdot>NID_s1_stm3_ex2,enter_s0_stm3_ex2,internal__stm3_ex2\<cdot>NID_s0_stm3_ex2,enter_s1_stm3_ex2,enter_i0_stm3_ex2,interrupt_stm3_ex2,internal__stm3_ex2\<cdot>NID_i0_stm3_ex2,internal__stm3_ex2\<cdot>NID_s1_stm3_ex2,share,terminate,exit_stm3_ex2 \<rbrace> | \<rbrakk> 
	  ((enter_i0_stm3_ex2 \<rightarrow> Trans_stm3_ex2) [ share \<mapsto> share ])) "

" ncBehaviour_stm3_ex2 = 
	((ncCoreBehaviour_stm3_ex2 \<Zhide> \<lbrace> enter_i0_stm3_ex2,enter_s0_stm3_ex2,enter_s1_stm3_ex2,exit_stm3_ex2,exited_stm3_ex2,internal__stm3_ex2 \<rbrace>) [ a__in\<cdot>x \<mapsto> a_in ]) "
...
" Memory_v1_stm3_ex2 = 
	(((get_v1_stm3_ex2\<^bold>!value \<rightarrow> Memory_v1_stm3_ex2(value))
	  \<box>
...
" stateful_stm3_ex2 = 
	((machineBody_stm3_ex2
	  ...
	  varMemory_stm3_ex2) \<Zhide> \<lbrace> set_v1,terminate,get_v1 \<rbrace>) "

" sharedVarMemory_stm3_ex2 = 
	(terminate \<rightarrow> Skip) "

" stm_stm3_ex2 = 
	((((((stateful_stm3_ex2 \<Zhide> \<lbrace> terminate \<rbrace>);; (SSTOP \<triangle> (terminate \<rightarrow> Skip))) [  ])
