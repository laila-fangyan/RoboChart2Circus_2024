...
" Trans_stm0_ex1 = 
	((((((((internal__stm0_ex1\<^bold>.NID_i0_stm0_ex1 \<rightarrow> Skip);; (enter_s0_stm0_ex1 \<rightarrow> Skip))
	  ...
	  \<box>
	  ((a__in\<^bold>.NID_s0_stm0_ex1 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm0_ex1 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm0_ex1 \<rightarrow> Skip);; (enter_s2_stm0_ex1 \<rightarrow> Skip))))))
	  \<box>
...
" ncCoreBehaviour_stm0_ex1 = 
	(((composeNodes_stm0_ex1 [ interrupt_i0_stm0_ex1 \<mapsto> internal__stm0_ex1\<cdot>NID_i0_stm0_ex1,  
	 ...
	 interrupt_s0_stm0_ex1 \<mapsto> a__in\<cdot>NID_s0_stm0_ex1,  
	 interrupt_s0_stm0_ex1 \<mapsto> interrupt_stm0_ex1,  
	 interrupt_s1_stm0_ex1 \<mapsto> interrupt_stm0_ex1,  
	 interrupt_s2_stm0_ex1 \<mapsto> interrupt_stm0_ex1 ]) [ share \<mapsto> share ])
	  \<lbrakk> | \<lbrace> interrupt_stm0_ex1,internal__stm0_ex1\<cdot>NID_i0_stm0_ex1,a__in\<cdot>NID_s0_stm0_ex1,enter_i0_stm0_ex1,enter_s1_stm0_ex1,enter_s2_stm0_ex1,exit_stm0_ex1,exited_stm0_ex1,share,enter_s0_stm0_ex1,b__in\<cdot>NID_s1_stm0_ex1,terminate \<rbrace> | \<rbrakk> 
	  ((enter_i0_stm0_ex1 \<rightarrow> Trans_stm0_ex1) [ share \<mapsto> share ])) "

" ncBehaviour_stm0_ex1 = 
	((ncCoreBehaviour_stm0_ex1 \<Zhide> \<lbrace> enter_i0_stm0_ex1,enter_s0_stm0_ex1,enter_s1_stm0_ex1,enter_s2_stm0_ex1,exit_stm0_ex1,exited_stm0_ex1,internal__stm0_ex1 \<rbrace>) [ a__in\<cdot>x \<mapsto> a_in,  
