...
" InactiveJct_i0_stm3_ex2 = 	(SSTOP \<triangle> (Activation_i0_stm3_ex2
                            	  \<box>
...
" Active_i0_stm3_ex2 = 	((SSTOP \<triangle> (interrupt_i0_stm3_ex2 \<rightarrow> Skip));; InactiveJct_i0_stm3_ex2) "
...
" composeNodes_stm3_ex2 = 	(((InactiveJct_i0_stm3_ex2
...
" ncCoreBehaviour_stm3_ex2 = 	((((composeNodes_stm3_ex2 [ interrupt_i0_stm3_ex2 \<mapsto> internal__stm3_ex2\<cdot>NID_i0_stm3_ex2,  
                             	 ...
                             	 interrupt_s0_stm3_ex2 \<mapsto> interrupt_stm3_ex2,  
                             	 interrupt_f0_stm3_ex2 \<mapsto> interrupt_stm3_ex2 ]) [ share \<mapsto> share,  
                             	 set_v \<mapsto> setL_v ])
...
" Memory_v_stm3_ex2(value) = 	(((get_v_stm3_ex2\<^bold>!value \<rightarrow> Memory_v_stm3_ex2(value))
                             	  \<box>
                             	  ((set_v_stm3_ex2\<^bold>?x__v \<rightarrow> Memory_v_stm3_ex2(x__v))
                             	  \<box>
                             	  (terminate \<rightarrow> Skip)))) "

" Memory_v1_stm3_ex2(value) = 	(((get_v1_stm3_ex2\<^bold>!value \<rightarrow> Memory_v1_stm3_ex2(value))
                              	  \<box>
                              	  ((set_v1_stm3_ex2\<^bold>?x__v \<rightarrow> Memory_v1_stm3_ex2(x__v))
                              	  \<box>
                              	  (terminate \<rightarrow> Skip)))) "
