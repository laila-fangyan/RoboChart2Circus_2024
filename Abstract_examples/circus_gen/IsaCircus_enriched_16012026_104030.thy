...
" Active_s0_stm04 = 	((SSTOP \<triangle> (a_out \<rightarrow> Skip));; (Behaviour_s0_stm04;; Exiting_s0_stm04)) "
...
" During_s1_stm04 = 	(((SSTOP \<triangle> (b_out \<rightarrow> Skip));; SSTOP) \<triangle> (interrupt_s1_stm04 \<rightarrow> Skip)) "
