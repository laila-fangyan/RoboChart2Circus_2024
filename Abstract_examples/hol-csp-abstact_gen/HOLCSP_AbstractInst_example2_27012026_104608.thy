...
abbrevation "InactiveJct_i0_stm3_ex2 \<equiv> RC_Junction.Inactive share enter_i0_stm3_ex2 interrupt_i0_stm3_ex2 terminate" 



abbrevation "InactiveFn_f0_stm3_ex2 \<equiv> RC_FinalState.Inactive share enter_f0_stm3_ex2 entered_f0_stm3_ex2 interrupt_f0_stm3_ex2 exit_stm3_ex2 exited_stm3_ex2 terminate"



abbrevation "Inactive_s0_stm3_ex2 \<equiv> RC_SimpleState.Inactive share enter_s0_stm3_ex2 entered_s0_stm3_ex2 interrupt_s0_stm3_ex2 exit_stm3_ex2 exited_stm3_ex2 terminate (SSTOP \<triangle> (b_out \<rightarrow> Skip)) Skip Skip"


abbrevation "Inactive_s1_stm3_ex2 \<equiv> RC_SimpleState.Inactive share enter_s1_stm3_ex2 entered_s1_stm3_ex2 interrupt_s1_stm3_ex2 exit_stm3_ex2 exited_stm3_ex2 terminate Skip Skip (SSTOP \<triangle> (get_v\<^bold>?v \<rightarrow> (assume True (Trans_tbd\<cdot>n) (SSTOP \<triangle> (guar True (set_v\<^bold>!(v + 1) \<rightarrow> Skip))))))"

abbrevation "Memory_v1_stm3_ex2 \<equiv> RC_Memory.Mem get_v1_stm3_ex2 set_v1_stm3_ex2 terminate"
abbrevation "Memory_v_stm3_ex2 \<equiv> RC_Memory.Mem get_v_stm3_ex2 set_v_stm3_ex2 terminate"
	
abbrevation "composeNodes_stm3_ex2 \<equiv> RC_CompNodes.composeNodes share terminte EolSequence [InactiveJct_i0_stm3_ex2, InactiveFn_f0_stm3_ex2, Inactive_s0_stm3_ex2, Inactive_s1_stm3_ex2]"
