...
theory circus_HOLCSP 
	imports "RC_HOL-CSP.proof_methods"
begin
...
definition "enterSS_in_stmbd_stm3_ex2 = { 
	  enter_i0_stm3_ex2, 
	  enter_f0_stm3_ex2, 
	  enter_s0_stm3_ex2, 
	  enter_s1_stm3_ex2 }"
	
definition "enteredSS_in_stmbd_stm3_ex2 = { 
	  entered_s1_stm3_ex2, 
	  entered_s0_stm3_ex2, 
	  entered_f0_stm3_ex2 }"
	
definition "internal_events_in_stmbd_stm3_ex2 = { 
	  enter_i0_stm3_ex2, 
	  enter_f0_stm3_ex2, 
	  enter_s0_stm3_ex2, 
	  enter_s1_stm3_ex2, 
...
definition "sem__events_stm_stm3_ex2 = { 
	  terminate, 
	  a_in, 
	  a_out, 
	  b_in, 
...
[simp del] :\<open>ncCoreBehaviour_stm3_ex2 = 
	((((composeNodes_stm3_ex2 [ interrupt_i0_stm3_ex2 := internal__stm3_ex2\<cdot>NID_i0_stm3_ex2,  
	 ...
	 interrupt_f0_stm3_ex2 := interrupt_stm3_ex2 ]) [ share := share,  
	 set_v := setL_v ])
	  ...
	  ((enter_i0_stm3_ex2 \<rightarrow> Trans_stm3_ex2) [ share := share,  
	 share := setL_v ])) [ setL_v := set_v ]) \<close> 

fixrec ncBehaviour_stm3_ex2 :: "chan_event process"
where 
[simp del] :\<open>ncBehaviour_stm3_ex2 = 
	((ncCoreBehaviour_stm3_ex2 \<Zhide> { enter_i0_stm3_ex2,enter_f0_stm3_ex2,enter_s0_stm3_ex2,enter_s1_stm3_ex2,exit_stm3_ex2,exited_stm3_ex2,internal__stm3_ex2 }) [ a__in\<cdot>x := a_in ]) \<close> 
...
[simp del] :\<open>machineBody_stm3_ex2 = 
	((ncBehaviour_stm3_ex2
	  ...
	  Skip) \<Zhide> { enteredSS_stm3_ex2 }) \<close> 
...
[simp del] :\<open>stateful_stm3_ex2 = 
	((machineBody_stm3_ex2
	  ...
	  varMemory_stm3_ex2) \<Zhide> { get_v,set_v1,terminate,get_v1,set_v }) \<close> 
...
[simp del] :\<open>stm_stm3_ex2 = 
	((((((stateful_stm3_ex2 \<Zhide> { terminate })\<^bold>;  (SSTOP \<triangle> (terminate \<rightarrow> Skip))) [  ])
	  \<lbrakk> | { shared } | \<rbrakk> 
	  Skip)
	  \<lbrakk> | { terminate } | \<rbrakk> 
	  sharedVarMemory_stm3_ex2) \<Zhide> {  }) \<close> 
