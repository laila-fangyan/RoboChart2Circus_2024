...
Active_i0_stm3_ex2 :: "chan_event process"	
where
[simp del] :\<open>InactiveJct_i0_stm3_ex2 = 
	(SSTOP \<triangle> (Activation_i0_stm3_ex2
	  \<box>
	  Termination_i0_stm3_ex2)) \<close>  | [simp del] :\<open>Activation_i0_stm3_ex2 = 
	(enter_i0_stm3_ex2 \<rightarrow> Active_i0_stm3_ex2) \<close>  | [simp del] :\<open>Termination_i0_stm3_ex2 = 
	(terminate \<rightarrow> Skip) \<close>  | [simp del] :\<open>Active_i0_stm3_ex2 = 
...
Interrupted_f0_stm3_ex2 :: "chan_event process"	
where
[simp del] :\<open>InactiveFn_f0_stm3_ex2 = 
	(SSTOP \<triangle> (Activation_f0_stm3_ex2
	  \<box>
	  Termination_f0_stm3_ex2)) \<close>  | [simp del] :\<open>Activation_f0_stm3_ex2 = 
	(enter_f0_stm3_ex2 \<rightarrow> Entering_f0_stm3_ex2) \<close>  | [simp del] :\<open>Termination_f0_stm3_ex2 = 
	(terminate \<rightarrow> Skip) \<close>  | [simp del] :\<open>Entering_f0_stm3_ex2 = 
	(entered_f0_stm3_ex2 \<rightarrow> Active_f0_stm3_ex2) \<close>  | [simp del] :\<open>Active_f0_stm3_ex2 = 
	(SSTOP \<triangle> (Termination_f0_stm3_ex2
	  \<box>
	  (interrupt_f0_stm3_ex2 \<rightarrow> Interrupted_f0_stm3_ex2))) \<close>  | [simp del] :\<open>Interrupted_f0_stm3_ex2 = 
...
Exiting_s0_stm3_ex2 :: "chan_event process"	
where
[simp del] :\<open>Inactive_s0_stm3_ex2 = 
	(SSTOP \<triangle> (Activation_s0_stm3_ex2
	  \<box>
	  Termination_s0_stm3_ex2)) \<close>  | [simp del] :\<open>Activation_s0_stm3_ex2 = 
	(enter_s0_stm3_ex2 \<rightarrow> Active_s0_stm3_ex2) \<close>  | [simp del] :\<open>Termination_s0_stm3_ex2 = 
	(terminate \<rightarrow> Skip) \<close>  | [simp del] :\<open>Active_s0_stm3_ex2 = 
	((SSTOP \<triangle> (b_out \<rightarrow> Skip))\<^bold>;  (Behaviour_s0_stm3_ex2\<^bold>;  Exiting_s0_stm3_ex2)) \<close>  | [simp del] :\<open>Behaviour_s0_stm3_ex2 = 
	(entered_s0_stm3_ex2 \<rightarrow> During_s0_stm3_ex2) \<close>  | [simp del] :\<open>During_s0_stm3_ex2 = 
	((Skip\<^bold>;  SSTOP) \<triangle> (interrupt_s0_stm3_ex2 \<rightarrow> Skip)) \<close>  | [simp del] :\<open>Exiting_s0_stm3_ex2 = 
...
[simp del] :\<open>Inactive_s1_stm3_ex2 = 
	(SSTOP \<triangle> (Activation_s1_stm3_ex2
	  \<box>
	  Termination_s1_stm3_ex2)) \<close>  | [simp del] :\<open>Activation_s1_stm3_ex2 = 
	(enter_s1_stm3_ex2 \<rightarrow> Active_s1_stm3_ex2) \<close>  | [simp del] :\<open>Termination_s1_stm3_ex2 = 
	(terminate \<rightarrow> Skip) \<close>  | [simp del] :\<open>Active_s1_stm3_ex2 = 
	(Skip\<^bold>;  (Behaviour_s1_stm3_ex2\<^bold>;  Exiting_s1_stm3_ex2)) \<close>  | [simp del] :\<open>Behaviour_s1_stm3_ex2 = 
	(entered_s1_stm3_ex2 \<rightarrow> During_s1_stm3_ex2) \<close>  | [simp del] :\<open>During_s1_stm3_ex2 = 
	((Skip\<^bold>;  SSTOP) \<triangle> (interrupt_s1_stm3_ex2 \<rightarrow> Skip)) \<close>  | [simp del] :\<open>Exiting_s1_stm3_ex2 = 
...
fixrec Memory_v_stm3_ex2 :: "int\<rightarrow>chan_event process"
where 
[simp del] :\<open>Memory_v_stm3_ex2\<cdot>value = 
	(((get_v_stm3_ex2\<^bold>!value \<rightarrow> Memory_v_stm3_ex2\<cdot>value)
	  \<box>
	  ((set_v_stm3_ex2\<^bold>?x__v \<rightarrow> Memory_v_stm3_ex2\<cdot>x__v)
	  \<box>
	  (terminate \<rightarrow> Skip)))) \<close> 

fixrec Memory_v1_stm3_ex2 :: "int\<rightarrow>chan_event process"
where 
[simp del] :\<open>Memory_v1_stm3_ex2\<cdot>value = 
	(((get_v1_stm3_ex2\<^bold>!value \<rightarrow> Memory_v1_stm3_ex2\<cdot>value)
	  \<box>
	  ((set_v1_stm3_ex2\<^bold>?x__v \<rightarrow> Memory_v1_stm3_ex2\<cdot>x__v)
	  \<box>
	  (terminate \<rightarrow> Skip)))) \<close> 
...
[simp del] :\<open>varMemory_stm3_ex2 = 
	(Memory_v_stm3_ex2\<cdot>0
	  \<lbrakk> { terminate } \<rbrakk> 
	  Memory_v1_stm3_ex2\<cdot>0) \<close> 
