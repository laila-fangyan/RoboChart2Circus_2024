...
\<comment> \<open>assumption-guarantee_violstm4\<close>
...
[simp del] :\<open>Trans_stm4\<cdot>n = 
	((SSTOP \<triangle> (get_v1\<^bold>?v1 \<rightarrow> (assume manual_input_assumption Trans_stm4\<cdot>n (((((((n = NID_i0_stm4) \<^bold>& (((internal__stm4\<^bold>.NID_i0_stm4 \<rightarrow> (SSTOP \<triangle> (guar manual_input_guarantee (set_v1\<^bold>!1 \<rightarrow> Skip))))\<^bold>;  (enter_s0_stm4 \<rightarrow> Trans_stm4\<cdot>NID_s0_stm4))))
	  \<box>
