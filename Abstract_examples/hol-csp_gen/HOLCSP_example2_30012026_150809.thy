...
[simp del] :\<open>ncBehaviour_stm3_ex2 = 
	((ncCoreBehaviour_stm3_ex2 \{ enter_i0_stm3_ex2,enter_f0_stm3_ex2,enter_s0_stm3_ex2,enter_s1_stm3_ex2,exit_stm3_ex2,exited_stm3_ex2,internal__stm3_ex2 }) [ a__in\<cdot>x := a_in ]) \<close> 
...
[simp del] :\<open>stm_stm3_ex2 = 
	((((((stateful_stm3_ex2 \{ terminate })\<^bold>;  (SSTOP \<triangle> (terminate \<rightarrow> Skip))) [  ])
