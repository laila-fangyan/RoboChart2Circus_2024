...
[simp del] :\<open>Trans_stm0_ex1 = 
	((((((((internal__stm0_ex1\<^bold>.NID_i0_stm0_ex1 \<rightarrow> Skip)\<^bold>;  (enter_s0_stm0_ex1 \<rightarrow> Skip))
	  ...
	  \<box>
	  ((a__in\<^bold>.NID_s0_stm0_ex1 \<rightarrow> Skip)\<^bold>;  ((SSTOP \<triangle> (exit_stm0_ex1 \<rightarrow> Skip))\<^bold>;  (SSTOP \<triangle> ((exited_stm0_ex1 \<rightarrow> Skip)\<^bold>;  (enter_s2_stm0_ex1 \<rightarrow> Skip))))))
	  \<box>
